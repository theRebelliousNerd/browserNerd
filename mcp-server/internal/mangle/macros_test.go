...
func TestSemanticMacros(t *testing.T) {
	...
	t.Run("Macro: screen_blocked", func(t *testing.T) {
		facts := []Fact{
			{
				Predicate: "dom_attr",
				Args:      []interface{}{testSessionID, "modal-1", "class", "modal-backdrop"},
				Timestamp: time.Now(),
			},
			{
				Predicate: "dom_node",
				Args:      []interface{}{testSessionID, "modal-1", "div", "", "body"},
				Timestamp: time.Now(),
			},
			{
				Predicate: "dom_attr",
				Args:      []interface{}{testSessionID, "dialog-1", "role", "dialog"},
				Timestamp: time.Now(),
			},
			{
				Predicate: "dom_attr",
				Args:      []interface{}{testSessionID, "loader-1", "id", "loading-overlay"},
				Timestamp: time.Now(),
			},
			{
				Predicate: "dom_attr",
				Args:      []interface{}{testSessionID, "spin-1", "class", "loading-spinner"},
				Timestamp: time.Now(),
			},
		}
		...
		facts := []Fact{
			{
				...
				Args:      []interface{}{testSessionID, "https://example.com"},
				Timestamp: time.Now(),
			},
			{
				Predicate: "dom_attr",
				Args:      []interface{}{testSessionID, "blocker", "class", "modal"},
				Timestamp: time.Now(),
			},
		}
		if err := engine.AddFacts(ctx, facts); err != nil {
	...
	t.Run("Macro: is_main_content", func(t *testing.T) {
		facts := []Fact{
			{
				Predicate: "dom_node",
				Args:      []interface{}{testSessionID, "main-1", "main", "Article text", "body"},
				Timestamp: time.Now(),
			},
			{
				Predicate: "dom_attr",
				Args:      []interface{}{testSessionID, "content-1", "id", "main"},
				Timestamp: time.Now(),
			},
			{
				Predicate: "dom_attr",
				Args:      []interface{}{testSessionID, "content-2", "role", "main"},
				Timestamp: time.Now(),
			},
			{
				Predicate: "dom_attr",
				Args:      []interface{}{testSessionID, "content-3", "class", "main-content"},
				Timestamp: time.Now(),
			},
		}
		if err := engine.AddFacts(ctx, facts); err != nil {
